...
//void Tamadas(int jatekos) //1 vagy 2
//{
//    int lepes = 0;
//    int talalt = 0;
//    int[] koordinatak = Beker();
//    string[,] TamadasJatekTer = JatekTer;
//    if (jatekos == 1)
//    {
//        StreamWriter sw = new StreamWriter("player1tamadas.txt");
//        /*JatekTer[x - 1, y - 1] = "X";*/
//        if (Kiiaratas(false)[x - 1, y - 1] == "X")
//        {
//            sw.WriteLine($"{lepes + 1}. lépés: talált({koordinatak[0]} {koordinatak[1]})");
//            talalt++;
//            lepes++;
//        }
//        else
//        {
//            sw.WriteLine($"{lepes + 1}. lépés: nem talált({koordinatak[0]} {koordinatak[1]})");
//            lepes++;
//        }
//        sw.Close();
//    }
//    else
//    {
//        StreamWriter sw = new StreamWriter("player2tamadas.txt");
//        /*JatekTer[x - 1, y - 1] = "X";*/
